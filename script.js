document.getElementById('fileInput').addEventListener('change', function(event) {
    ...
    reader.onload = function(e) {
        ...
        // New extraction logic for the name between "Generated by" and "on"
        let textContent = doc.body.textContent;
        let generatedByIndex = textContent.indexOf("Generated by");
        let onIndex = textContent.indexOf("on", generatedByIndex);

        let userName = "User"; // Default value
        if (generatedByIndex !== -1 && onIndex !== -1) {
            userName = textContent.substring(generatedByIndex + "Generated by".length, onIndex).trim();
        }

        // Rest of your code to extract the names and create the chart remains unchanged

        // Extract names from div with class _a6-i (assuming this part remains unchanged)
        ...
        // US Census letter frequencies (same as before)
