document.getElementById('fileInput').addEventListener('change', function(event) {
    ...
    reader.onload = function(e) {
        try {
            ...
            console.log(`User letter frequency: ${userLetterFrequency}, Census frequency: ${censusLetterFrequency}, Difference: ${percentageDifference}%`);
            ...
            console.log('Chart data prepared:', { labels, yourData, censusData });
            ...
            document.getElementById('results').innerHTML = `<p style="color: red;">There was an error processing your file. Please ensure it is a valid Facebook friend list HTML file.</p>`;
        }
    };
